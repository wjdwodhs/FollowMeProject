                    ...
                    <ul class="menu">
                        ...
                        <li class="menu-item">
                            <a href="${ contextPath }/document/recallList" class="menu-link">
                                ...
                                <span class="menu-text"> <b>회수 문서함</b> </span>
                            </a>
                        </li>
                        <li class="menu-item">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card" style="margin-top: 50px;">
                                    <div class="card-body">
                                        <div>
                                            <h4 class="header-title">회수된 문서</h4>
                                            <p class="sub-header">
                                                Access recalled Electronic documents                                     
                                            </p>
                                        </div>
                                        ...
                                        <div id="pagingArea" style=" display: flex; justify-content: center; margin-top: 20px;">
														                <ul class="pagination">
														                    <li class="page-item ${ pi.currentPage == 1 ? 'disabled':'' }"><a class="page-link" href="${ contextPath }/document/recallList?page=${pi.currentPage - 1}">Previous</a></li>
														                    
														                    <c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
														                    <li class="page-item ${ pi.currentPage == p ? 'disabled':'' }"><a class="page-link" href="${ contextPath }/document/recallList?page=${p}">${ p }</a></li>
														                    </c:forEach>
														                    
														                    <li class="page-item ${ pi.currentPage >= pi.maxPage ? 'disabled':''}" ><a class="page-link" href="${ contextPath }/document/recallList?page=${pi.currentPage + 1}">Next</a></li>
														                </ul>
														            </div>
                                    </div>
                                </div> <!-- end card -->
