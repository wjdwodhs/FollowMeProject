                    ...
                    <ul class="menu">
                        ...
                        <li class="menu-item">
                            <a href="${ contextPath }/document/refList" class="menu-link">
                                ...
                                <span class="menu-text"> <b>참조 문서함</b> </span>
                            </a>
                        </li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card" style="margin-top: 50px;">
                                    <div class="card-body">
                                        <div>
                                            <h4 class="header-title">참조 문서함</h4>
                                            <p class="sub-header">
                                                Access a list of Electronic documents that refer to me                                
                                            </p>
                                        </div>
                                        ...
                                        <div id="pagingArea" style=" display: flex; justify-content: center; margin-top: 20px;">
														                <ul class="pagination">
														                    <li class="page-item ${ pi.currentPage == 1 ? 'disabled':'' }"><a class="page-link" href="${ contextPath }/document/refList?page=${pi.currentPage - 1}">Previous</a></li>
														                    
														                    <c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
														                    <li class="page-item ${ pi.currentPage == p ? 'disabled':'' }"><a class="page-link" href="${ contextPath }/document/refList?page=${p}">${ p }</a></li>
														                    </c:forEach>
														                    
														                    <li class="page-item ${ pi.currentPage >= pi.maxPage ? 'disabled':''}" ><a class="page-link" href="${ contextPath }/document/refList?page=${pi.currentPage + 1}">Next</a></li>
														                </ul>
														            </div>
                                    </div>
                                </div> <!-- end card -->
