                            ...
                            <div class="card" style="margin-top: 50px;">
                                    <div class="card-body">
                                        ...
                                        <div id="pagingArea" style=" display: flex; justify-content: center; margin-top: 20px;">
														                <ul class="pagination">
														                    <li class="page-item ${ pi.currentPage == 1 ? 'disabled':'' }"><a class="page-link" href="${ contextPath }/document/list?page=${pi.currentPage - 1}">Previous</a></li>
														                    
														                    <c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
														                    <li class="page-item ${ pi.currentPage == p ? 'disabled':'' }"><a class="page-link" href="${ contextPath }/document/list?page=${p}">${ p }</a></li>
														                    </c:forEach>
														                    
														                    <li class="page-item ${ pi.currentPage >= pi.maxPage ? 'disabled':''}" ><a class="page-link" href="${ contextPath }/document/list?page=${pi.currentPage + 1}">Next</a></li>
														                </ul>
														            </div>
                                    </div>
                                </div> <!-- end card -->
