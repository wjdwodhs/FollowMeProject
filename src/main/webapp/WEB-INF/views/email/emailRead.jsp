	                    ...
	                    <div class="page-title-box">
	                        <div class="page-title-right">
	                            <ol class="breadcrumb m-0">
	                                ...
	                                <li class="breadcrumb-item active">수신메일</li>
	                            </ol>
	                        </div>
	                        <h4 class="page-title">수신메일</h4>
	                    </div>
	                </div>
	            </div>
	            <!-- end page title -->
	                    ...
	                    <div class="card">
	                        <div class="card-body">
	                            ...
	                            <div class="inbox-leftbar">
	                                ...
	                                <a href="email-compose.html" class="btn btn-danger w-100 waves-effect waves-light"
	                                   style="background-color: #FFBE98; border: 1px solid #FFBE98;">작성하기</a>
	                            ...
	                            <div class="inbox-rightbar">
	                                ...
	                                <div class="mt-4">
	                                    <h5 class="font-18">[거래처] 3월 청구금액 및 거래명세표 요청 件</h5>
