	                        ...
	                        <div class="card-body">
	                            ...
	                            <div class="inbox-leftbar">
		                          ...
		                          <div class="mail-list mt-4">
		                              ...
		                              <a href="${contextPath }/email/outbox.bo" class="text-primary fw-bold"><i class="dripicons-exit me-2"></i>보낸메일</a>
	                            ...
	                            <div class="inbox-rightbar">
	                                ...
	                                <div class="mt-4">
	                                    ...
	                                    <div class="d-flex align-items-start mb-3 mt-1">
	                                        <div class="w-100">
	                                            ...
	                                            <small class="text-muted">To: ${email.emailTo}</small>
	                                        </div>
	                                    </div>
                                	...
                                	<div class="row">
                                     ...
                                     <div class="col-xl-4">
	                                    ...
	                                    <div class="mt-5">
	                                        <a href="${contextPath }/email/outbox.bo" class="btn btn-secondary me-2" style="background-color: #FFBE98; border: 1px solid #FFBE98;">
