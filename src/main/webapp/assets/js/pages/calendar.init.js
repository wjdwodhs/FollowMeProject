document.addEventListener('DOMContentLoaded', () => {
            ...
            const holidaySource = {
                ...
                backgroundColor: '#FFBE98'  // rgb code 대체 가능
            }
            ...
            const calendar = new FullCalendar.Calendar(targetDiv, {
                ...
                events:[ // 데이터 영역
							     { 
							      title: 'test Title1', // 제목
							      start: '2024-05-01', // 시작일자
							      end: '2024-05-02', // 종료일자
                    backgroundColor: 'red'
							    },
							    {
							      title: 'test Title2', // 제목
							      start: '2024-05-08', // 시작일자
							      end: '2024-05-09' // 종료일자
							    },{ 
							      title: 'test Title3', // 제목
							      start: '2024-05-13', // 시작일자
							      end: '2024-05-15' // 종료일자
							    }
                ],
